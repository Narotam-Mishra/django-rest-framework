...
SECRET_KEY = 'django-insecure-m+)evcshif)e2udxre^@f(!uf2ts3(*a_bji&5mi7v=caem970'
...
ALGOLIA = {
  'APPLICATION_ID': '1091QYUB5I',
  'API_KEY': '77438fa7e3fefeb6a9fb3b3ed569ad2e', # Your Write API Key
  'INDEX_PREFIX': 'djapp',
}
...
SIMPLE_JWT = {
    ...
    "REFRESH_TOKEN_LIFETIME": datetime.timedelta(minutes=2), # days=1
}